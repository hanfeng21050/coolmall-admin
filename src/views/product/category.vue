<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button v-if="draggable" style="margin-left:10px " size="mini" @click="batchSave">批量保存</el-button>
      <el-button type="danger" style="margin-left:10px " size="mini" @click="batchDelete">批量删除</el-button>
    </div>
    <el-tree
      ref="menuTree"
      :data="menus"
    ...
    <el-dialog :title="title" :visible.sync="dialogVisible" width="30%" :close-on-click-modal="false">
      <el-form :model="category">
        <el-form-item label="分类名称">
          <el-input v-model="category.name" autocomplete="off" @keyup.enter.native="submitData" />
        </el-form-item>
