<template>
  <div class="app-container">
    <div class="filter-container">
      <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
        <el-form-item label="仓库">
          <el-select v-model="dataForm.wareId" style="width:120px;" placeholder="请选择仓库" clearable>
        ...
        <el-form-item>
          ...
          <el-dropdown :disabled="dataListSelections.length <= 0" style="margin-left:10px" @command="handleBatchCommand">
    ...
    <el-table v-loading="dataListLoading" :data="dataList" border style="width: 100%;" @selection-change="selectionChangeHandle">
      ...
      <el-table-column prop="id" header-align="center" align="center" width="50" label="id" />
      <el-table-column prop="purchaseId" header-align="center" align="center" width="100" label="采购单id" />
      <el-table-column prop="skuId" header-align="center" align="center" label="采购商品id" />
      <el-table-column prop="skuNum" header-align="center" align="center" label="采购数量" />
      <el-table-column prop="skuPrice" header-align="center" align="center" label="采购价格" />
...
export default {
  ...
  methods: {
    mergeItem() {
      const items = this.dataListSelections.map((item) => {
        return item.id
      })
      if (!this.purchaseId) {
        this.$confirm(
