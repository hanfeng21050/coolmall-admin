<template>
  <div class="app-container">
    <div class="filter-container">
      <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
        ...
        <el-form-item>
          ...
          <el-button v-if="isAuth('member:growthchangehistory:delete')" type="danger" :disabled="dataListSelections.length <= 0" @click="deleteHandle()">批量删除</el-button>
        </el-form-item>
      </el-form>
    </div>
    <el-table v-loading="dataListLoading" :data="dataList" border style="width: 100%;" @selection-change="selectionChangeHandle">
      ...
      <el-table-column prop="changeCount" header-align="center" align="center" label="改变的值（正负计数）" />
      <el-table-column prop="note" header-align="center" align="center" label="备注" />
      <el-table-column prop="sourceType" header-align="center" align="center" label="积分来源[0-购物，1-管理员修改]" />
