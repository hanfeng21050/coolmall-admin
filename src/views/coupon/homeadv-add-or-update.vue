  ...
  <el-dialog :title="!dataForm.id ? '新增' : '修改'" :close-on-click-modal="false" :visible.sync="visible">
    <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="120px" @keyup.enter.native="dataFormSubmit()">
      <el-form-item label="名字" prop="name">
        <el-input v-model="dataForm.name" placeholder="名字" />
      </el-form-item>
      <el-form-item label="图片地址" prop="pic">
        <single-upload ref="image" v-model="dataForm.pic" />
      </el-form-item>
    ...
    <el-form-item label="点击数" prop="clickCount">
      ...
      <el-form-item label="广告详情连接地址" prop="url">
        <el-input v-model="dataForm.url" placeholder="广告详情连接地址" />
      </el-form-item>
      <el-form-item label="备注" prop="note">
        <el-input v-model="dataForm.note" type="textarea" placeholder="备注" maxlength="255" />
      </el-form-item>
  ...
  data() {
    return {
      ...
      dataForm: {
        ...
        status: '',
        clickCount: '',
        url: 'https://github.com/hanfeng21050',
        note: '',
        sort: '',
        publisherId: '',
        authId: ''
      ...
      dataRule: {
        ...
        authId: [{ required: true, message: '审核者不能为空', trigger: 'blur' }]
      }
    }
  },
  methods: {
